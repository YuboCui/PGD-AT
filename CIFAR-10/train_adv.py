...
if __name__ == "__main__":
    ...
    attack = PGD(model, 8 / 255, 2 / 255, 7)
    optim = torch.optim.SGD(
        model.parameters(), lr=0.1, momentum=0.9, weight_decay=0.0002
    )
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optim, [30, 40], 0.1)
    train(
        model,
        train_loader,
        val_loader,
        ...
        max_epoch=200,
        early_stop=15,
        save_path="weights/cifar10_adv.pth",
        attack=attack,
    )
